...
Common causes:
- Different operating systems → different system libraries, commands, and file systems
...
3. Simulator
A simulator does not replicate the real system exactly. It only imitates the behavior of the system using models.
Examples
1. Flight simulator
2. Network simulator
Simulator Flow
